namespace OrderingProducts
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "Открыть справочник \"Товары\"";
            ...
            this.button2.Text = "Открыть справочник \"Единицы измерения\"";
            ...
            this.button3.Text = "Открыть спрвочник \"Группы товаров\"";
            ...
            this.button4.Text = "Открыть спрвочник \"Статусы заказов\"";
            ...
            this.button5.Text = "Открыть документ \"Заказы\"";
            ...
            this.button6.Text = "Открыть отчет \"Отчет для сборщика\"";
